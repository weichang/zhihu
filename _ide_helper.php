 ...
 * Generated for Laravel 5.0.33 on 2016-11-29.
 *
...
namespace {
    ...
    class Auth extends \Illuminate\Support\Facades\Auth{
         ...
         *
         * @return \App\Synergy\Models\User|null 
         * @static 
         */
         ...
         * @param mixed $id
         * @param bool $remember
         * @return \App\Synergy\Models\User 
         * @static 
         */
    ...
    class CSV extends \Monokakure\CSV\CSVFacade{
         ...
         * @static 
         */
        public static function setEncode($to, $from){
            return \Monokakure\CSV\Factory::setEncode($to, $from);
        }
         ...
         * @static 
         */
        public static function create($arr, $header = null){
            return \Monokakure\CSV\Factory::create($arr, $header);
        }
         ...
         * @static 
         */
        public static function parse($filepath, $hasHeader = false){
            return \Monokakure\CSV\Factory::parse($filepath, $hasHeader);
        }
        
    }


    class Selector extends \App\Synergy\Models\Selector{
